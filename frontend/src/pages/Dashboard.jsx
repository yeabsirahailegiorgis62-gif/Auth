...
import TemplateGallery from "../components/productivity/TemplateGallery";
import FolderSidebar from "../components/productivity/FolderSidebar";
...
export default function Dashboard() {
  ...
  }, [activeTab, searchQuery, selectedFolderId, selectedTagId]);

  useEffect(() => {
    fetchDocs();
    fetchFavoriteIds();
    fetchWorkspaces();
  }, [fetchDocs, fetchFavoriteIds, fetchWorkspaces]);
  ...
  const handleCreateDoc = async (template = null) => {
    try {
      setCreating(true);
      const title = template ? template.title : "Untitled Document";
  ...
  return (
    <div className="flex min-h-screen bg-slate-50/50">
      ...
      <TemplateGallery 
        ...
        onSelectTemplate={handleCreateDoc}
      />
